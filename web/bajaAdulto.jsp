...
<html>
    ...
    <body>
        <nav>
                <div class="nav-wrapper blue ">
                    ...
                    <ul id="nav-mobile" class="left hide-on-med-and-down">
                        ...
                        <li><a href="bajaAdulto.jsp" class="brand-logo center">Baja Adulto</a></li>
                    </ul>
                </div>
            </nav>
        <div class="center">
        ...
        <form  method="post" action="bajaAdulto.jsp">
            <div class="center" >
                <table>
                    <tr>
                        <td style="width:37%">
            ...
            <div class="center">
                <input type="submit" name="borrarAdulto" onclick="confirm('¿Seguro que deseas dar de baja al adulto?');" value="Dar de baja" class="waves-effect waves-light btn"/>
            </div>
        </form>
        <div id="uno" class="container">
            <%
                String mensaje="";
                if (request.getParameter("borrarAdulto") != null) {
                    mensaje = MemberModelo.deleteAdulto(Integer.parseInt(request.getParameter("idmember")));
                    if(mensaje.equals("")){
                        mensaje="El adulto ha sido borrado exitosamente!";
                    }
            %>
            <script>
                alert('<%= mensaje%>');
