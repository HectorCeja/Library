...
<html>
    ...
    <body>
        <nav>
                <div class="nav-wrapper blue ">
                    ...
                    <ul id="nav-mobile" class="left hide-on-med-and-down">
                        ...
                        <li><a href="altaJovenRespuesta.jsp" class="brand-logo center">Alta Joven</a></li>
                    </ul>
                </div>
            </nav>
        <div class="center">
        ...
        <div class="center">
            <a class="waves-effect waves-light btn" href="altaJoven.jsp">Regresar</a>
        </div>
        <div id="uno" class="container">        
             <%  String infoMensaje = "";
                if (request.getParameter("altaJoven") != null) {
                     
                    infoMensaje = MemberModelo.altaJoven(Integer.parseInt(request.getParameter("idmember")), request.getParameter("nombre"), request.getParameter("apellido"), request.getParameter("inicial"), Integer.parseInt(request.getParameter("adulto")), request.getParameter("fecha"));
                    if (infoMensaje.equals("")) {
                        infoMensaje = "Joven Ingresado con Éxito.!";
                    }%>
            <script>
                alert('<%= infoMensaje%>');
            </script>  
